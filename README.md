...
<br/>
• Built a supervised ML model to predict machine failures using sensor/operational data, performed end-to-end data cleaning, feature engineering and model training achieving 92% accuracy. 
<br/><br/>
